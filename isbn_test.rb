...
class Testnum < Minitest::Test
 ...
 #  #___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___#  valid chars.
  ...
  def test_validity_fail
	...
	#___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___#
	def test_val13
		assert_equal(true, check_isbn("9780470059029"))
	end
  #___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___#
  def test_not_val13
	...
	#___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___#
	def test_13_mathing
		assert_equal(true, mathing("9780471486480"))
	end	
	#___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___#
  def test_13mathing_and
	 	assert_equal(true, mathing("9780470059029"))
	end
	#___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___#
	def test_13andmathing_again 
	 	assert_equal(false, mathing("1234567890765"))
	end
	#___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___#
	def test_13_full
		assert_equal(true, check_isbn("9780470059029"))
	...
	def test_13_full_w_spcendsh
		assert_equal(true, check_isbn("877195869x"))
	end
	#___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___^^^___#
